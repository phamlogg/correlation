...
try:
    ...
    print('Không tìm thấy file Output.xlsx')
except:
    print('Lỗi tính St. Dev')
else:
...
title = ["Name", "Standard Dev.", "Pair", "Correlation"]
...
try:
    ...
    print(f'Tính correlation lỗi')
else:
    print(f'Tính correlation thành công!') 
...
# Conditional format cell value
ft = Font(color = "00FF6600")

try:
    for i in range(2, ws2.max_row + 1):
        cell = ws2.cell(row = i, column = 4)
        if cell.value >= -0.3 and cell.value <= 0.3:
            cell.offset(row = 0, column = - 1).font = ft
            cell.font = ft
except:
    print('Format cell lỗi')
else:
    print('Format cell thành công!')
